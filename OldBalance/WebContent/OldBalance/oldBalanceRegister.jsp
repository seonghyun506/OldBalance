...
<script type="text/javascript">
	$(function() {
		...
		$('#idCheck').click(function(){
			windowObj=window.open("<%=pjName%>/OldBalance/oldBalanceCheckId.jsp","중복 확인","width=460, height=350");
		});
	});
			...
			<br/><br/>
				...
				<form action="<%= pjName %>/Register?cmd=input-member" method='post'>
					...
					<br/><br/>
						...
						<h3><input class='agree' name="agree" type="checkbox" value="na" /> 위 사이트는 탈퇴가 불가합니다.(필수)</h3>
						<h2 class="title"></h2>
